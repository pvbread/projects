This is a basic text-based interpretation of the game Towers of Hanoi. Although it can be made simply with lists instead of stacks, I utilize stacks here to practice the form.
